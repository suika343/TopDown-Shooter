...
{
    #region UNITS
    //values to help calculate where the doorways are
    ...
    //Animator parameters - Destroyable Objects
    ...
    public const float contactDamageCollisionResetDelay = 0.5f; //in seconds
    #endregion
}
